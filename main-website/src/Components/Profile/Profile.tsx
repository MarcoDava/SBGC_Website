...
const Navbar = () => {
    ...
    return(
        <motion.div initial={{ opacity: 0, x: -200 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 2 }}className="fixed top-0 left-0 right-0 flex flex-row justify-start items-start h-full w-[15vh] z-50">
            <div className="pt-[3vh] nav-container flex justify-start items-center flex-col gap-[5vh] bg-[#4a3636]/90 h-[100vh] shadow-lg/15">
            ...
            expanded ? 
            <div className="flex flex-row justify-center items-center bg-[#4a3636]  h-[5vh] w-[5vh] p-[1.5vh] shadow-lg/15 rounded-[50%]">
                ...
                :
            <div className="flex flex-row justify-between items-center bg-[#4a3636] h-[5vh] w-[10vh] p-[1.5vh] shadow-lg/15 rounded-[2.5vh]">
                <img className="h-[4.5vh]" src={logo} alt="Logo" decoding="async" />
