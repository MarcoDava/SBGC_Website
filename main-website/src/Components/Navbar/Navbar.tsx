    ...
    return(
        <div className="fixed top-0 left-0 right-0 flex flex-row justify-start items-start h-full">
            <div className="nav-container flex justify-start items-start flex-col gap-[5vh] bg-[#B2A592]/90 h-[100vh] shadow-lg/15">
                <img className={`overflow-hidden transition-all ${expanded ? "w-[10vh] h-[10vh]": "w-0"}`} src="" alt="Logo"></img>
            ...
            <div className="flex flex-row justify-center items-center bg-white ml-[2vh] mt-[2vh] h-[5vh] w-[5vh] p-[1.5vh] shadow-lg/15 rounded-[50%]">
                ...
                :
            <div className="flex flex-row justify-center items-center bg-white ml-[2vh] mt-[2vh] h-[5vh] w-[10vh] p-[1.5vh] shadow-lg/15 rounded-[2.5vh]">
                <img src={logo}></img>
                |
